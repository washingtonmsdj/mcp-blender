    ...
    def game_assets_ecosystem_catalog(self, payload: dict[str, Any]) -> ActionResult:
        ...
        catalog = {
            "integrated": {
                ...
                "engine_validation": ["unity_verified_handoff", "unity_model_import_audit"],
                "dcc": ["blender"],
            ...
            "engine_import_validation": {
                "unity": {
                    "verified_handoff_action": "game_assets.unity_import_generated",
                    "model_audit_action": "game_assets.unity_model_audit",
                    "required_order": [
                        "verify_ordax_generated_asset_sha256_and_provenance",
                        "atomic_copy_into_assets",
                        "confirmed_unity_editor_refresh",
                        "forced_assetdatabase_model_import",
                        "load_imported_gameobject",
                        "inspect_importer_and_runtime_geometry",
                    ],
                    "model_audit_metrics": [
                        "asset_importer_type",
            ...
            "optimization_targets": {
                ...
                "implemented": ["static_lod_generation"],
                "future_passes": [
